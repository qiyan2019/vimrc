...
let g:template['javascript']['for'] = "for (var ".g:rs."...".g:re." in ".g:rs."...".g:re.") \{\<cr>".
            \g:rs."...".g:re."\<cr>}\<cr>"
let g:template['javascript']['switch'] = "switch (".g:rs."...".g:re.")\ {\<cr>case ".g:rs."...".g:re." :\<cr>break;\<cr>case ".
            \g:rs."...".g:re." :\<cr>break;\<cr>default :\<cr>break;\<cr>}"
let g:template['javascript']['if'] = "if (".g:rs."...".g:re.")\ {\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['javascript']['while'] = "while (".g:rs."...".g:re.")\ {\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['javascript']['ife'] = "if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} else \{\<cr>".g:rs."...".
            \g:re."\<cr>}"
